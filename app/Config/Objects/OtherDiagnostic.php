...
$config = array(
	...
	"OtherDiagnostic.Name" => "Otros diagnósticos",
	"OtherDiagnostic.ShortName" => "Otros diag.",
	"OtherDiagnostic.Fields" => array(
