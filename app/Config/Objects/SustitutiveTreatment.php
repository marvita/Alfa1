...
$config = array(
	...
	"SustitutiveTreatment.Name" => "Tratamiento sustitutivo",
	"SustitutiveTreatment.Name" => "Trat. sustit.",
	"SustitutiveTreatment.Fields" => array(
	...
	"SustitutiveTreatment.HideFields" => array('created', 'modified'),
	/* this settings define how associations are displayed in default form and view templates */
	"SustitutiveTreatment.Associations" => array(
		"PatientFile" => array(
