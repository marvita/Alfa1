...
$config = array(
	...
	"AatDetermination.Name" => "Motivo de la Determinación de AAT",
	"AatDetermination.ShortName" => "Motivo Determ. AAT",
	"AatDetermination.Fields" => array(
