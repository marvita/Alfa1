...
$config = array(
	...
	"PulmonaryStudy.Name" => "Funcionalismo pulmonar",
	"PulmonaryStudy.ShortName" => "Funcion. pulm.",
	"PulmonaryStudy.Fields" => array(
