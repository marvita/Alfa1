...
$config = array(
	...
	"StGeorgeCuestionnaire.Name" => "Datos Cuestionario St. George",
	"StGeorgeCuestionnaire.ShortName" => "Cuest. St. George",
	"StGeorgeCuestionnaire.Fields" => array(
	...
	"StGeorgeCuestionnaire.HideFields" => array('created', 'modified'),
	/* this settings define how associations are displayed in default form and view templates */
	"StGeorgeCuestionnaire.Associations" => array(
		"PatientFile" => array(
