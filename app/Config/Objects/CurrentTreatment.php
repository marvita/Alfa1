...
$config = array(
	...
	"CurrentTreatment.Name" => "Tratamiento actual",
	"CurrentTreatment.ShortName" => "Trat. Actual",
	"CurrentTreatment.Fields" => array(
