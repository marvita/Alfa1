		...
		<div class="um_box_mid_content">
			...
			<div class="um_box_mid_content_mid" id="register">
				<div class="um_box_mid_content_mid_left">
					...
					<?php 
					  /* Marta: en caso de que el usuario no sea admin evita mostrar el groupo: Admin - User 
                       * esto es para que el usuario pueda editar su profile
                       * 
                       * */
			...
			<?php   } // fin editar profile  ?>
                    ...
                    <!-- Marta: agregar Matricula, Provincia, Ciudad -->					
                    <div>
                        <div class="umstyle3"><?php echo __('Matricula');?><font color='red'>*</font></div>
                        <div class="umstyle4" ><?php echo $this->Form->input("matricula" ,array('label' => false,'div' => false,'class'=>"umstyle5" ))?></div>
                        <div style="clear:both"></div>
                    </div>					
                    <div>
                        <div class="umstyle3"><?php echo __('Provincia');?><font color='red'>*</font></div>
                        <div class="umstyle4" ><?php echo $this->Form->input("provincia" ,array('label' => false,'div' => false,'class'=>"umstyle5" ))?></div>
                        <div style="clear:both"></div>
                    </div>  
                    <div>
                        <div class="umstyle3"><?php echo __('Ciudad');?><font color='red'>*</font></div>
                        <div class="umstyle4" ><?php echo $this->Form->input("ciudad" ,array('label' => false,'div' => false,'class'=>"umstyle5" ))?></div>
                        <div style="clear:both"></div>
                    </div>                      
