...
function UsermgmtInIt(&$controller) {
	...
	*/
	if(!defined("EMAIL_FROM_ADDRESS")) {
		define("EMAIL_FROM_ADDRESS", 'lpedretti@suserver.com');
	}
	...
	*/
	if(!defined("EMAIL_FROM_NAME")) {
		define("EMAIL_FROM_NAME", 'Alfa 1 Argentina');
	}
	...
	*/
	if(!defined("DEFAULT_GROUP_ID")) {
		define("DEFAULT_GROUP_ID", '8b11c5e1-2cf3-11e2-85a5-020054746872');
	}
	...
	*/
	if(!defined("ADMIN_GROUP_ID")) {
		define("ADMIN_GROUP_ID", '8b103451-2cf3-11e2-85a5-020054746872');
	}
	...
	*/
	if(!defined("GUEST_GROUP_ID")) {
		define("GUEST_GROUP_ID", '8b138160-2cf3-11e2-85a5-020054746872');
	}
	/*
	...
	*/
	if(!defined("PRIVATE_KEY_FROM_RECAPTCHA")) {
		define("PRIVATE_KEY_FROM_RECAPTCHA", '6Ldg9dgSAAAAAPw0Mb9OGhnBsk_NVwOwFecQwXU9');
	}
	/*
		set Admin group id here
	*/
	if(!defined("PUBLIC_KEY_FROM_RECAPTCHA")) {
		define("PUBLIC_KEY_FROM_RECAPTCHA", '6Ldg9dgSAAAAALN7yRtGiANVT-vR7z5FWiVqZXTY');
	}
	/*
		set login cookie name
	*/
	if(!defined("LOGIN_COOKIE_NAME")) {
		define("LOGIN_COOKIE_NAME", 'CliccGo');
	}
